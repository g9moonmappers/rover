    ...
    return Node(
        ...
        parameters=[
            {"use_sim_time": ParameterValue(use_sim_time, value_type=bool)},
            {
                ...
                "safe_turn_speed": 0.90,
                "min_turn_clearance_m": 0.20,
                "corridor_creep_enabled": True,
                "corridor_min_side_clearance_m": 0.22,
                "corridor_min_total_width_m": 0.44,
                "corridor_creep_speed_mps": 0.18,
                "corridor_creep_scale": 0.55,
                "allow_reverse_when_blocked": True,
                "safety_controls_backup": True,
